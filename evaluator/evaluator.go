...
var ( // we reference these objects in the evaluator to avoid creating them over and over again
...
func Eval(node ast.Node, env *object.Environment) object.Object {
	...
	case *ast.CallExpression:
		function := Eval(node.Function,env) // returns a function object whether it's a function literal or an identifier
		if isError(function){ 
			return function
		}
...
func isError(obj object.Object) bool { // check if an object is an error object
	if obj != nil {
...
// unwrapReturnValue takes an object and returns the underlying value if the object is a ReturnValue object
...
//evaExpressions takes a slice of ast.Expression nodes and evaluates them in the given environment
